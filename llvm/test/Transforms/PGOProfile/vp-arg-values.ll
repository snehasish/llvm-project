...
; GEN-NEXT: call void @llvm.instrprof.value.profile(ptr @__profn_foo, i64 {{-?[0-9]+}}, i64 [[V0]], i32 3, i32 0)
; GEN-NEXT: call void @llvm.instrprof.value.profile(ptr @__profn_foo, i64 {{-?[0-9]+}}, i64 %n, i32 3, i32 1)
; GEN-NOT: call void @llvm.instrprof.value.profile({{.*}} i32 3, i32 2)
...
; OFF-NOT: call void @llvm.instrprof.value.profile
